...
- **β-glucan**: 15 SNPs above Bonferroni (−log10p ≥ 6.77). Top SNP: `2H:41996626` on 2H at 41,996,626 bp (−log10p = 8.226). λ_GC = 0.9763.
- **Fiber**: 3 SNPs above Bonferroni (−log10p ≥ 6.77). Top SNP: `4H:24707376` on 4H at 24,707,376 bp (−log10p = 7.896). λ_GC = 0.9745.
- **Protein**: 1 SNPs above Bonferroni (−log10p ≥ 6.77). Top SNP: `3H:106623911` on 3H at 106,623,911 bp (−log10p = 6.899). λ_GC = 0.9820.
- **Starch**: 2 SNPs above Bonferroni (−log10p ≥ 6.77). Top SNP: `7H:573606460` on 7H at 573,606,460 bp (−log10p = 6.999). λ_GC = 0.9811.
